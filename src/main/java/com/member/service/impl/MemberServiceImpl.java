...
//		}
	...
	public MemberVO login(String account, String password) {
		...
		MemberVO memberVO = dao.login(account, password);
	...
	public String verifyUser(String account, String password){
	    /*
	     ...
	     0004 acct locked
	     */
	    Optional<MemberVO> member = Optional.of(dao.selectByUsername(account));
	    String result="9999";
	    if(member.isPresent()){
	        if(member.get().getAccount().equals(account)){
	          ...
	          //新增了以下這段：
	                ...
	                .setSubject(account) //我以account當subject
